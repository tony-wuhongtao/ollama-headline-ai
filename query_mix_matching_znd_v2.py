...
if __name__ == "__main__":
    ...
    matches = combined_search(query, vector_db, vector_weight=0.2, keyword_weight=0.8, top_k=5)
    ...
    for video, combined_score, vector_score, keyword_score in matches:
        ...
        print(f"Teacher: {video['video_teacher']}")
        print(f"Keywords: {video['video_keywords']}")
        print(f"KnowledgePoints: {video['video_knowledgePoints']}")
        print(f"Summary: {video['video_simpleSummary']}")
        print("---Scores--")
